...
SWIFT_CLASS("_TtC13SwiftPractise11AppDelegate")
...
SWIFT_CLASS("_TtC13SwiftPractise14ViewController")
...
@property (nonatomic, strong) UIProgressView * _Nonnull pView;
@property (nonatomic, strong) UIButton * _Nonnull pushButton;
